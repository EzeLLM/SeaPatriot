...
def create_custom_map(lat, lon, address, status, from_location, to_location, direction, eta, last_report):
    ...
    ax.text(0.02, 0.98, info_text, transform=ax.transAxes, fontsize=15, verticalalignment='top', 
    ...
    plt.savefig('enhanced_map_with_direction.png', dpi=300, bbox_inches='tight')
